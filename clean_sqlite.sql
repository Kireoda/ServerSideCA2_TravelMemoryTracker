...
--
ALTER TABLE memories
  MODIFY id bigint(20) UNSIGNED NOT NULL , =8;

--
--  for table migrations
--
ALTER TABLE migrations
  MODIFY id int(10) UNSIGNED NOT NULL , =10;

--
--  for table trips
--
ALTER TABLE trips
  MODIFY id bigint(20) UNSIGNED NOT NULL , =7;

--
--  for table trip_images
--
ALTER TABLE trip_images
  MODIFY id bigint(20) UNSIGNED NOT NULL , =60;

--
--  for table users
--
ALTER TABLE users
  MODIFY id bigint(20) UNSIGNED NOT NULL , =3;
